...
<template>
  ...
  <el-input class="w-40" v-model.number="searchInfo.startDuration" placeholder="最小值" />
  —
  <el-input class="w-40" v-model.number="searchInfo.endDuration" placeholder="最大值" />
</el-form-item>
  ...
  <el-select v-model="searchInfo.status" clearable filterable placeholder="请选择" @clear="()=>{searchInfo.status=undefined}">
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate  template-id="voice_File" />
            <ExportExcel  template-id="voice_File" filterDeleted/>
            <ImportExcel  template-id="voice_File" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column sortable align="left" label="时长" prop="duration" width="120" />
    ...
    {{ filterDict(scope.row.status,statusOptions) }}
            ...
            <el-table-column align="left" label="存储路径" prop="path" width="120" />

        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            <template #default="scope">
            <el-button  type="primary" link class="table-button" @click="getDetails(scope.row)"><el-icon style="margin-right: 5px"><InfoFilled /></el-icon>查看</el-button>
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateFileFunc(scope.row)">编辑</el-button>
